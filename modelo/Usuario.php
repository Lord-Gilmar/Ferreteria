...
class Usuario{
    ...
    function crear($nombre,$apellido,$edad,$ci,$pass,$tipo,$avatar){
        ...
        if(!empty($this->objetos)){
            ...
            $sql="INSERT INTO usuario(nombre_us,apellidos_us,edad,ci_us,contrasena_us,us_tipo,avatar) VALUES (:nombre,:apellido,:edad,:ci,:pass,:tipo,:avatar);";
            $query = $this->acceso->prepare($sql);
            $query->execute(array(':nombre'=>$nombre,':apellido'=>$apellido,':edad'=>$edad,':ci'=>$ci,':pass'=>$pass,':tipo'=>$tipo,':avatar'=>$avatar));
            echo 'add';
        }
    }
