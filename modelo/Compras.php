...
class Compras{
    ...
    function crear($codigo,$fecha_compra,$fecha_entrega,$total,$id_estado,$id_proveedor){
        $sql="INSERT INTO compra(codigo,fecha_compra,total,id_estado_pago,id_proveedor) values (:codigo,:fecha_compra,total,:id_estado_pago,:id_proveedor);";
            $query = $this->acceso->prepare($sql);
            $query->execute(array(':codigo'=>$codigo,':fecha_compra'=>$fecha_compra,':total'=>$total,':id_estado_pago'=>$id_estado,':id_proveedor'=>$id_proveedor));
    ...
    function listar_compras(){
        $sql="SELECT concat(c.id,' | ',c.codigo) as codigo, fecha_compra,total,e.nombre as estado, p.nombre as proveedor FROM compra as c
    ...
    function obtenerDatos($id){
        $sql="SELECT concat(c.id,' | ',c.codigo) as codigo, fecha_compra,total,e.nombre as estado, p.nombre as proveedor,
